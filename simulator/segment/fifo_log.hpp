...
namespace flashCache
{
    ...
    public:
        FIFOLog(uint64_t log_capacity, uint64_t block_size,
        ...
        void update(std::vector<candidate_t> items);
    ...
    private:
        ...
        struct Block
        {
            // std::unordered_set<candidate_t> _items; // Block中包含的对象列表
            std::unordered_map<uint64_t, candidate_t> _items; // Block中包含的对象列表
