...
namespace traceAnalyzer
{
    ...
    private:
        ...
        std::unordered_map<obj_size_t, uint32_t> obj_size_req_cnt_; // 请求的对象大小分布
        std::unordered_map<obj_size_t, uint32_t> obj_size_obj_cnt_; // 第一次出现的对象的大小分布
        ...
        std::vector<uint32_t> window_obj_size_obj_cnt_; // 第一次出现的对象的对数大小分布
